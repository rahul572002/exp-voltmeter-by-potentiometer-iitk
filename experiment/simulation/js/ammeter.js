...
var image2 = document.getElementById("switch2A");
...
function switchonoff2() {
  ...
  if (rotateBtn2.style.fill === "red" && circuit == false) {
    ...
    image2.style.transform = `rotate(${40}deg)`;
...
function getResistance(id) {
  ...
  if (id === "resistance1") {
    ...
    document.getElementById("resistance-1-display-svg").innerHTML =
      resistance + " " + "ohm";
  }
}
var resistance1 = 0;
function getResistance12(id) {
  // let resistance=0;
  if (id === "resistance2" && reading) {
    resistance1 = document.getElementById(id).value;
    document.getElementById("resistance-2-display").innerText =
      resistance1 + " " + "ohm";

    document.getElementById("resistance-2-display-svg").innerHTML =
      resistance1 + " " + "ohm";
    document.getElementById("ammeter1").innerHTML =
     ( (12 / (2 + +resistance1))  + +0.05).toFixed(2) + " " + "A";
  }
}
